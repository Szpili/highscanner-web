      ...
      <section className="border-b border-zinc-200 dark:border-zinc-800">
        <div className="mx-auto max-w-5xl px-6 py-20 sm:py-28">
          <span className="inline-flex items-center rounded-full bg-emerald-100 dark:bg-emerald-900/40 px-3 py-1 text-xs font-medium text-emerald-800 dark:text-emerald-200">
            Ceny od społeczności pacjentów · aktualizowane na bieżąco
          </span>
          ...
          <p className="mt-6 max-w-2xl text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed">
            Realne ceny medycznej maja z paragonów wrzucanych przez
            pacjentów i z publicznie dostępnych źródeł. Wpisz odmianę i
            miasto — dostań listę aptek gdzie jest taniej. Alerty cenowe na
            Telegramie, społeczność pacjentów na Discordzie.
          </p>
      ...
      <section className="border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/40">
        <div className="mx-auto max-w-5xl px-6 py-14">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
            {[
              { value: "670+", label: "aptek w bazie obserwacji" },
              { value: "160+", label: "odmian wykrytych" },
              { value: "na bieżąco", label: "aktualizacja" },
